<template>
  <div>
    ...
    <div v-for="(item, i) in portfolioItems" :key="i" :class="{'mt-16' : i != 0}">
      ...
      <div v-if="item.fields.featureItemType" class="w-full h-64 bg-cover bg-grey-200 bg-center mt-4 rounded" v-lazy:background-image="`https:${content.fields.featurePhoto.fields.file.url}`"></div>
